...
#
# Cross Compile a library from source for armeabi-v7a


# ----- ABI Specific Configuration -----

# the target architecture (the name of toolchain dir)
export TARGET_ARCH=arm
# the target abi name (the name of install dir)
export TARGET_ABI=armeabi-v7a
# the name of the compilation target (also known as `host`)
export TARGET_HOST=arm-linux-androideabi
# the path to toolchain root
export TOOLCHAIN_ROOT=${TOOLCHAIN_HOME}/${TARGET_ARCH}
