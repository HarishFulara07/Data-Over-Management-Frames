...
//            continue;
//
//        if (strncmp(reinterpret_cast<const char *>(nla_data(tb_mcgrp[CTRL_ATTR_MCAST_GRP_NAME])), grp->group,
//                    static_cast<size_t>(nla_len(tb_mcgrp[CTRL_ATTR_MCAST_GRP_NAME]))))
//            continue;
//
