...
public class MainActivity extends AppCompatActivity {
    ...
    private void onTransmit() {
        ...
        if (networkInterfaces.size() == 1) {
            ...
            asyncOnInterfaceSelected(networkInterfaces.get(0), userInput.data, userInput.effort);
            return;
        }
        ...
        builder.setItems(
                ...
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        asyncOnInterfaceSelected(networkInterfaces.get(i), userInput.data, userInput.effort);
                    }
                }
        );
        builder.create().show();
    ...
    private void asyncOnInterfaceSelected(NetworkInterface networkInterface, String ieData, int effort) {
        ...
        params.deliveryEffort = effort;
        params.ieData = ieData;
        params.interfaceName = networkInterface.getName();

        new ProbeStuffingTask().execute(params);
    }
    ...
    private class ProbeStuffingTask extends AsyncTask<AsyncParams, Integer, Void> {
        ...
        protected Void doInBackground(AsyncParams... asyncParams) {
            ...
            setInformationElementsInProbeRequests(
                    asyncParams[0].interfaceName,
                    asyncParams[0].ieData,
                    asyncParams[0].deliveryEffort
            );
            return null;
        }
